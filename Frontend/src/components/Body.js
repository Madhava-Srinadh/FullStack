  ...
  return (
    <div className="h-screen bg-peach-100 flex items-center justify-center overflow-hidden p-6">
      <div className="container mx-auto w-full max-w-6xl h-full flex flex-col">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12 bg-white rounded-2xl shadow-lg p-6 flex-shrink-0">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <input
              ...
              className="w-32 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 transition placeholder-gray-400"
            />
            <input
              type="number"
            ...
            <button
              ...
              className="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition shadow-md flex items-center gap-2"
            >
          ...
          <div className="flex gap-4 items-center">
            <label className="w-48 p-3 border border-gray-300 rounded-lg cursor-pointer flex items-center justify-center bg-white hover:bg-gray-100 transition">
              <input
                type="file"
                accept="image/*"
                className="hidden"
        ...
        {/* Error */}
        {(errorRestaurants || errorLocation || errorImage) && (
        ...
        <div className="flex-grow overflow-y-auto no-scrollbar">
          {/* Show Home Button (Only when restaurants are visible) */}
          {results.length > 0 && isSearching && (
            <div className="mb-4 flex justify-center">
              <button
                onClick={handleHomeClick}
                className="bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition shadow-md flex items-center"
              >
          ...
          {/* Show More Button (Inside same container) */}
          {!isSearching && restaurants.length > 0 && !loadingRestaurants && (
            <div className="mt-6 flex justify-center">
              <button
                onClick={handleLoadMore}
                className="bg-orange-500 text-white px-8 py-3 mb-16 rounded-lg hover:bg-orange-600 transition shadow-md flex items-center gap-2"
              >
